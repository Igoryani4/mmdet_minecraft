...
launcher = 'none'
load_from = '/content/drive/MyDrive/minecraft_project/artifacts/fcos/best_coco_bbox_mAP_epoch_10.pth'
log_level = 'INFO'
...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=500, start_factor=0.333, type='LinearLR'),
